...
uses
  ...
  ACBrBase, ACBrSocket, ACBrCEP, frameLocalizar_Cliente;
...
procedure TfrmConsulta.edtClientesChange(Sender: TObject);
begin
  ListarClientes;
end;
...
procedure TfrmConsulta.frameLocalizaCliente1edtClientesChange(Sender: TObject);
begin
  ListarClientes;
end;
