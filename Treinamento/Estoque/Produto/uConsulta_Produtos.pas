...
uses
  ...
  JvDBGrid, Data.DB, ZAbstractRODataset, ZAbstractDataset, ZDataset, Vcl.DBCtrls;
...
type
  ...
  public
    { Public declarations }
    SQLText_Produtos, SQLText_UM, SQLText_Grupos : String;
  end;
...
var
  Texto: String;
begin
  Texto := SQLText_Produtos + ' WHERE id > 0';
...
begin
  SQLText_Produtos  := sqlProdutos.SQL.Text;
  SQLText_UM        := sqlUnid_Medidas.SQL.Text;
  SQLText_Grupos    := sqlGrupos.SQL.Text;
end;
