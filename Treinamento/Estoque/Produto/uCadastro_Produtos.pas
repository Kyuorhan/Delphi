...
begin
  ...
  begin
    MostraAviso('A descrição do produto deve ser Informado!');
  ...
  begin
    MostraAviso('O campo Tipo de Unidade é Obrigatório');
  ...
  begin
    MostraAviso('O Preço de Compra deve ser Informado!');
  ...
  begin
    MostraAviso('O Preço de Venda deve ser Informado!');
    edtP_Venda.SetFocus;
    Exit;
  end;
  ...
  begin
    MostraAviso('O Grupo é Obrigatório!');
