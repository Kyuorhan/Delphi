...
uses
  ...
  uCaixas_Movimentos_Pesquisa in 'uCaixas_Movimentos_Pesquisa.pas' {fCaixas_Movimentos_Pesquisa},
  uCaixas_Movimentos_Cadastro in 'uCaixas_Movimentos_Cadastro.pas' {fCaixas_Movimentos_Cadastro};
...
begin
  ...
  Application.CreateForm(TfCaixas_Movimentos_Pesquisa, fCaixas_Movimentos_Pesquisa);
  Application.CreateForm(TfCaixas_Movimentos_Cadastro, fCaixas_Movimentos_Cadastro);
  Application.Run;
end.
