...
begin
    ...
    begin
      ...
      sqlTipos_Documentos.ApplyUpdates;
      sqlTipos_Documentosdocumento.AsString     := frmCadastro_Receber.edtTipo_Documento.Text;
      sqlTipos_Documentos.ApplyUpdates;
...
begin
  ...
  begin
    ShowMessage('O documento já está pago.');
    Exit;
  end;
...
begin
  ...
  begin
    ...
    MostraAviso
      ('Este cliente possui registros em contas a Receber e não pode ser excluído.');
end;
...
begin
  ...
  begin
    ...
    { if not odd(DBGrid1d.sqlContas_Receber.DataSet.RecNo) then // se for ímpar
      begin
